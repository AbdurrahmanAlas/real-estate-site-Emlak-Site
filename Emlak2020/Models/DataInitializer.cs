    ...
    public class DataInitializer:DropCreateDatabaseIfModelChanges<DataContext>
    {
        ...
        protected override void Seed(DataContext context)
        {
...

            {
                ...
                new Semt(){SemtAd="KOCASİNAN",SehirId=2},
                new Semt(){SemtAd="KEÇİÖREN",SehirId=3},
            ...
            var mahalle = new List<Mahalle>()
            {
                ...
                new Mahalle(){MahalleAd="SAHABİYE ",SemtId=2},
                new Mahalle(){MahalleAd="TALATPAŞA",SemtId=2},
            ...
            {
                new Ilan() {Açıklama="ev güzel",Adres="Şan sokak",OdaSayısı=5,BanyoSayısı=2,Kredi=true,Fiyat=2000,MahalleId=1,SemtId=1,SehirId=1,DurumId=1,TipId=1,Alan=250,Telefon="05454081442",Kat="2.kat",UserName="Alas"},
                                new Ilan() {Açıklama="ev güzel degil",Adres="esra sokak",OdaSayısı=4,BanyoSayısı=2,Kredi=true,Fiyat=1000,MahalleId=2,SemtId=2,SehirId=2,DurumId=2,TipId=4,Alan=150,Telefon="05454081442",Kat="3.kat",UserName="Abdurrahman"},
            ...
            {
                new Resim(){ResimAd="10.jpg",IlanId=1},
